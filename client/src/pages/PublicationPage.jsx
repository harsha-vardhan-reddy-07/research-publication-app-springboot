...
const PublicationPage = () => {
  ...
  const handleApprove = async () => {
      await axios.post(`http://localhost:6001/approve-publication/${id}`, {evaluator: localStorage.getItem('username'), evaluatorId: localStorage.getItem('userId') ,evaluationNote: evaluatorsNote, evaluationDate: new Date()}).then(
        (res)=>{
